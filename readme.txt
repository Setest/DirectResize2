...
Вы можете переписывать файлы превью по вашему желанию и управлять загрузкой поддерживающих скриптов JS и стилей тем самым исключить конфликт с уже размещенными скриптами. ОБЯЗАТЕЛЬНО после установки загляните в параметры плагина, чтобы настроить его под свои нужды.
